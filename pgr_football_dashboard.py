...
def render_bookmaker_odds_card(row: pd.Series):
    ...
    card_html = f'<div style="padding:16px;margin:10px 0;border-radius:14px;background:radial-gradient(circle at top left, rgba(0,255,166,0.08), rgba(15,23,42,0.96));border:1px solid rgba(0,255,166,0.25);box-shadow:0 0 15px rgba(0,255,166,0.1);"><div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:8px;"><div><div style="font-size:16px;font-weight:600;color:#E5E7EB;">{fixture}</div><div style="font-size:20px;font-weight:700;color:#00FFA6;margin-top:4px;">{selection}</div></div><div style="text-align:right;"><div style="font-size:11px;padding:4px 9px;border-radius:999px;background:{ev_bg};border:1px solid {ev_border};color:#E5E7EB;">EV {ev:+.1f}%</div></div></div><div style="font-size:12px;color:#9CA3AF;margin-bottom:10px;">{comparing_text}</div>{bookmaker_section}{fair_vs_best}</div>'
    st.markdown(card_html, unsafe_allow_html=True)
