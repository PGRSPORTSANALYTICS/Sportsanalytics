...
- **Strategic Product Pivot (Dec 9, 2025):** Value Singles now core subscription product due to lower bookmaker margins (4-8% vs SGP's 28-45%). Value Singles: EV 5%, confidence 56%, odds 1.55-1.95, daily limit 10 (core product). SGP: Premium "monster picks" only when EV>8-10%, daily limit reduced, max odds 8.0x. ML Parlays + College Basketball as secondary products. Target: 15-20% realistic ROI.
