...
- **Basketball Settings (Dec 3, 2025):** Restored to original looser settings: 50% confidence (was 55%), 15 singles max (was 6), odds range 1.40-5.50 (was 1.50-4.50), 3 parlays max. This allows more volume while maintaining 3% EV minimum edge requirement.
